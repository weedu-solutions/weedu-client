        ...
        <ChakraProvider>
          ...
          <Routes>
            ...
            <Route path={ROUTES.ACTIONS}
              element={<RequireAuth fallbackAuth={<LoginPage />} roles={['CONSULTORES', 'COLABORADOR', 'GESTORES']} element={<Actions />} />}
            />
            <Route path={ROUTES.CREATE_ACTION}
              element={<RequireAuth fallbackAuth={<LoginPage />} roles={['CONSULTORES', 'COLABORADOR', 'GESTORES']} element={<CreateAction />} />}
            />
